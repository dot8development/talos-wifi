...
func (suite *WifiConfigSuite) TestReconcile() {
	...
	// presence of any wifi configuration should request the wireless kernel module set
	wifiModuleIDs := []resource.ID{"wifi/cfg80211", "wifi/mac80211", "wifi/iwlwifi", "wifi/iwlmvm"}
