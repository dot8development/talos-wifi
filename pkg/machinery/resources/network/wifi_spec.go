...
// WifiSpec resource holds Wi-Fi network link configuration.
type WifiSpec = typed.Resource[WifiSpecSpec, WifiSpecExtension]

// WifiSpecSpec describes Wi-Fi configuration of a wireless link.
//
//gotagsrewrite:gen
//redactgen:gen
...
// WifiNetwork describes a single Wi-Fi network to connect to.
//
//gotagsrewrite:gen
